      ...
      <div className={`flex items-center justify-center gap-3 ${className}`}>
        {publicInfo?.instagram && (
          <a href={publicInfo.instagram} target="_blank" rel="noopener noreferrer"
            className="w-9 h-9 rounded-xl flex items-center justify-center bg-white/10 hover:bg-white/20 border border-white/15 transition-all"
            title="Instagram">
      ...
      <div className="hidden lg:flex min-h-screen">
        ...
        <div className="relative w-[60%] flex-shrink-0">
          ...
          <div className="relative z-10 flex flex-col h-full px-14 py-12 justify-between">
            ...
            {/* Footer desktop */}
            <div>
              <SocialIcons className="mb-3 justify-start" />
