    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-background dark:bg-muted rounded-lg p-4 text-center">
            <div className="text-3xl font-bold text-foreground dark:text-foreground">{totalAttendances}</div>
            <div className="text-sm text-secondary-foreground dark:text-muted-foreground">{t('aulas_realizadas')}</div>
          </div>
          <div className="bg-background dark:bg-muted rounded-lg p-4 text-center">
            <div className="text-3xl font-bold text-foreground dark:text-foreground">{attendanceRate}%</div>
            <div className="text-sm text-secondary-foreground dark:text-muted-foreground">{t('taxa_presenca')}</div>
          </div>
        </div>
